    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        prevBtn.addEventListener("click", function() {
            slideContainer.scrollBy({
                left: -300, // Adjust this value as needed to control the scroll amount
                behavior: 'smooth'
            });
        });
                ...
                <div class="w-[70%] flex gap-10 border border-yellow-100">
                    ...
                    <div class="card gap-16 items-center mx-auto max-w-screen-xl lg:grid lg:grid-cols-1 overflow-hidden rounded-lg">
                        ...
                        <div class="flex overflow-x-auto gap-4">
                            <div class="relative">
                                <button id="prevBtn" class="prev-btn absolute left-0 top-1/2 transform -translate-y-1/2 bg-gray-200 hover:bg-gray-300 px-3 py-2 rounded-md z-10">Prev</button>
                                ...
                                <button id="nextBtn" class="next-btn absolute right-0 top-1/2 transform -translate-y-1/2 bg-gray-200 hover:bg-gray-300 px-3 py-2 rounded-md z-10">Next</button>
                            </div>
                        </div>
...
<div class="card gap-16 items-center mx-auto max-w-screen-xl lg:grid lg:grid-cols-1 overflow-hidden rounded-lg">
    <div class="w-full h-full dark:text-white flex flex-col">
        ...
        <div class="flex">
            ...
            <div class="w-[70%] flex gap-10 border border-yellow-100">
                <div class="w-[40px] h-[100px]">Template</div>
                <div class="w-[40px] h-[100px]">Template</div>
                <div class="w-[40px] h-[100px]">Template</div>
            </div>
            <div class="w-[15%] border border-yellow-100">Right Side Search bar with some text</div>
...
>>>>>>> d1315ddb93394af8624f718c60bca51b91ae711f
